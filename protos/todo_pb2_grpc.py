...
class TodoServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetTodo = channel.unary_unary(
                ...
                _registered_method=True)
        self.RetrieveTodo = channel.unary_unary(
                '/todo.TodoService/RetrieveTodo',
                request_serializer=protos_dot_todo__pb2.RetrieveTodoRequest.SerializeToString,
                response_deserializer=protos_dot_todo__pb2.RetrieveTodoResponse.FromString,
                _registered_method=True)
...
class TodoServiceServicer(object):
    ...
    def RetrieveTodo(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_TodoServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'RetrieveTodo': grpc.unary_unary_rpc_method_handler(
                    servicer.RetrieveTodo,
                    request_deserializer=protos_dot_todo__pb2.RetrieveTodoRequest.FromString,
                    response_serializer=protos_dot_todo__pb2.RetrieveTodoResponse.SerializeToString,
            ),
    }
...
class TodoService(object):
    ...
    def RetrieveTodo(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/todo.TodoService/RetrieveTodo',
            protos_dot_todo__pb2.RetrieveTodoRequest.SerializeToString,
            protos_dot_todo__pb2.RetrieveTodoResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
